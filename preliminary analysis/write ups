...
**(see corresponding code 4)**

Table 1 displays the results of our linear probability model estimating full day attendance. We find that on an
adjusted basis, a one mile increase in distance from the school the child attends is associated with about a 0.5 
percentage point increase in likelihood of attending a full day of kindergarten (p<.001). We also find, holding all 
else equal, that every one additional sibling is associated with about a three percentage point decrease in likelihood 
of attending a full day of school (p<.001). Similarly, on an adjusted basis, we find that living below the poverty 
threshold is associated with about an eight percentage point decrease in the likelihood of attending a full day of 
kindergarten (p<.001). Holding all else constant, children with an IEP and those without have equal probabilities of 
attending full day kindergarten (p>.05).
